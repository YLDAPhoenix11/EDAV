...
In a word, getting more salary may slightly increase the chance of certification. But it is only slightly. Getting a readonable annual wage may be more helpful.
...
ggplot(univ, aes(x = university , y = count))+
  ...
  ggtitle("in the apllicants either work in educational service or have a life, physical, and social science occupation,
how many of them work in universities")
```

In the 7256 cases, more than two thirds are working in university.
